...
caffe_root = "/home/gueste/code/caffe/RefineDet"
...
save_dir = "/net4/merkur/storage/deeplearning/users/gueste/TRAINING_test/"+\
    "models/VGGNet/VOC0712/{}".format(job_name)
### Directory which stores the snapshot of models.
#snapshot_dir = "models/VGGNet/VOC0712/{}".format(job_name)      # ORIGINAL
snapshot_dir = "/net4/merkur/storage/deeplearning/users/gueste/TRAINING_test/"+\
    "models/VGGNet/VOC0712/{}".format(job_name)
### Directory which stores the job script and log file.
#job_dir = "jobs/VGGNet/VOC0712/{}".format(job_name)             # ORIGINAL
job_dir = "/net4/merkur/storage/deeplearning/users/gueste/TRAINING_test/"+\
    "jobs/VGGNet/VOC0712/{}".format(job_name)
### Directory which stores the detection results.
#output_result_dir = "{}/data/RefineDet/pascal/VOCdevkit/results/VOC2007/{}/Main".format(os.environ['HOME'], job_name)   # ORIGINAL
output_result_dir = "/net4/merkur/storage/deeplearning/users/gueste/data/"+\
    "RefineDet/pascal/VOCdevkit/results/VOC2007/{}/Main".format(job_name)
