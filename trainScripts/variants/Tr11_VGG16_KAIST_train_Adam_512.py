...
max_iter_train  = 10000  # Maximum number of solver iterations (#Epochs = #AllTrainImages / batch_size)
...
job_name_template = "Tr11_i10k_Adam_{}"  # Job name for output (Brackets will be filled with resize info!)
