...
max_iter_train  = 1500  # Maximum number of solver iterations (#Epochs = #AllTrainImages / batch_size)
...
job_name_template = "2_Tr2-1_OF_D4_{}"  # Job name for output (Brackets will be filled with resize info!)
