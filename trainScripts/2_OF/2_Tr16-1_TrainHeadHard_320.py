...
job_name_template = "2_Tr16-1_OF_D7_{}"  # Job name for output (Brackets will be filled with resize info!)
subsetName        = "2_train-all-T_D7"  # Subset name to train on (existing)
