...
stepvalues      = [15000]  # Iteration values for changing learning rate
...
job_name_template = "2_Tr5_OF_D4_{}"  # Job name for output (Brackets will be filled with resize info!)
