...
job_name_template = "3_Tr23_3FpI_D4_{}"  # Job name for output (Brackets will be filled with resize info!)
...
trainHard_factor    = 10  # Factor for learning rate (original learning rate gets multiplied with this in VGGNetBody)
