...
job_name_template = "3_Tr25_3FpI_D4_{}"  # Job name for output (Brackets will be filled with resize info!)
...
trainHard_factor    = 4  # Factor for learning rate (original learning rate gets multiplied with this in VGGNetBody)
...
retrain_vgg         = True
retrain_arm_odm     = False  # Set this to true if you want to retrain ARM & ODM layers from scratch (rename layers)
