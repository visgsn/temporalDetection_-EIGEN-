...
max_iter_train  = 1200  # Maximum number of solver iterations (#Epochs = #AllTrainImages / batch_size)
...
job_name_template = "3_Tr10_3FpI_D4_{}"  # Job name for output (Brackets will be filled with resize info!)
...
trainHard_factor    = 25  # Factor for learning rate (original learning rate gets multiplied with this in VGGNetBody)
