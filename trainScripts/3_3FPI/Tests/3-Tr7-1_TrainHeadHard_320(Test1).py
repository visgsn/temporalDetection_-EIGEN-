...
accum_batch_size    = 240  # Must be a multiple of batch_size
...
trainHard_factor    = 100  # Factor for learning rate (original learning rate gets multiplied with this in VGGNetBody)
