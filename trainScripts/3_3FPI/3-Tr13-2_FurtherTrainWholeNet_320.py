...
snapshot_train  = 20  # Number of iterations to take a snapshot
base_lr_train   = 0.01  # Learning rate to start with (ORIGINAL: 0.0005)
...
job_name_template = "3_Tr13-2_3FpI_D4_{}"  # Job name for output (Brackets will be filled with resize info!)
...
pretrain_model = \
    "/net4/merkur/storage/deeplearning/users/gueste/TRAINING_test/models/VGGNet/KAIST/3_train-all-T_D4/" \
    "3_Tr9-2_3FpI_D4_320x320/3_Tr9-1 (Vortraining)/KAIST_3_Tr9-1_3FpI_D4_320x320_iter_1200.caffemodel"
########################################################################################################################
