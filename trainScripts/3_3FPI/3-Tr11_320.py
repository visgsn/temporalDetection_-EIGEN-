...
max_iter_train  = 12000  # Maximum number of solver iterations (#Epochs = #AllTrainImages / batch_size)
snapshot_train  = 400  # Number of iterations to take a snapshot
...
job_name_template = "3_Tr11_3FpI_D4_{}"  # Job name for output (Brackets will be filled with resize info!)
...
trainHard_factor    = 3  # Factor for learning rate (original learning rate gets multiplied with this in VGGNetBody)
...
pretrain_model = \
    "/net4/merkur/storage/deeplearning/users/gueste/TRAINING_test/models/VGGNet/KAIST/train-all-T/refinedet_50home_320x320/KAIST_refinedet_50home_320x320_iter_40000.caffemodel"
########################################################################################################################
