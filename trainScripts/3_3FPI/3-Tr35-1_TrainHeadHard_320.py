...
job_name_template = "3_Tr35-1_3FpI_D1_{}"  # Job name for output (Brackets will be filled with resize info!)
subsetName        = "3_train-all-T_D1"  # Subset name to train on (existing)
