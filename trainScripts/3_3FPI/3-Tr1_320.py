...
max_iter_train  = 60000  # Maximum number of solver iterations (#Epochs = #AllTrainImages / batch_size)
...
job_name_template = "3_Tr1_3FpI_i60k_{}"  # Job name for output (Brackets will be filled with resize info!)
