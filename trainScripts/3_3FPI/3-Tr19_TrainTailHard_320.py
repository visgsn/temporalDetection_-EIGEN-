...
max_iter_train  = 3500  # Maximum number of solver iterations (#Epochs = #AllTrainImages / batch_size)
snapshot_train  = 125  # Number of iterations to take a snapshot
...
job_name_template = "3_Tr19_3FpI_D4_{}"  # Job name for output (Brackets will be filled with resize info!)
