...
snapshot_train  = 1000  # Number of iterations to take a snapshot
...
job_name_template = "3_Tr6_3FpI_i20k_{}"  # Job name for output (Brackets will be filled with resize info!)
