...
snapshot_train  = 10  # Number of iterations to take a snapshot
...
job_name_template = "3_Tr12-2_3FpI_D4_{}"  # Job name for output (Brackets will be filled with resize info!)
