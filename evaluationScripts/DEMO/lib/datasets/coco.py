...
class coco(imdb):
    def __init__(self, image_set, year):
        ...
        #self._data_path = '/home/shifeng/data/Object_Detection/coco'            # ORIGINAL
        # *** HOME ***
        self._data_path = '{}/data/coco'.format(os.environ['HOME'])
        # *** WORK ***
        #self._data_path = '/net4/merkur/storage/deeplearning/users/gueste/data/coco' # Noch einmal checken!
